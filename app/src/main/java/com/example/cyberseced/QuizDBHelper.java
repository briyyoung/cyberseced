...
public class QuizDBHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        ...
        QuizQuestions q6 = new QuizQuestions("Protect your ____", "Hat", "Password", "Lunch", "Keyboard", 2, QuizCategories.safe_online);
        addQuestion(q6);
        QuizQuestions q7 = new QuizQuestions("____ your computer screen when you leave your desk", "Lock", "Hide", "Smash", "Show", 1, QuizCategories.safe_online);
        addQuestion(q7);
        QuizQuestions q8 = new QuizQuestions("Cover up ______ & ______ documents when you leave your desk", "Emotional & Sensitive", "Discrete & Quiet", "Confidential & Sensitive", "Empty & Useless", 3, QuizCategories.safe_online);
        addQuestion(q8);
        QuizQuestions q9 = new QuizQuestions("File documents in _____ cabinets to prevent a privacy breach", "Blue", "Open", "Locked", "Small", 3, QuizCategories.safe_online);
        addQuestion(q9);
        QuizQuestions q10 = new QuizQuestions("Destroy or ____ old data", "Archive", "Move", "Hide", "Spread", 1, QuizCategories.safe_online);
        addQuestion(q10);

        QuizQuestions q11 = new QuizQuestions("Which of these is NOT a common technique involved in Social Engineering Attacks?", "Baiting", "Phishing", "Zoomware", "Scareware", 3, QuizCategories.Social_Engineering);
        addQuestion(q11);
        QuizQuestions q12 = new QuizQuestions("In the Social Engineering Lifestyle, what does an attacker typically do?", "They randomly pick a victim", "They identify them with no set vision", "They follow a series of steps to identify and then attack", "They follow steps to become best friends", 3, QuizCategories.Social_Engineering);
        addQuestion(q12);
        QuizQuestions q13 = new QuizQuestions("Which of these is NOT part of the Social Engineering Life Cycle?", "Investigation", "Bait", "Exit", "Hook", 2, QuizCategories.Social_Engineering);
        addQuestion(q13);
        QuizQuestions q14 = new QuizQuestions("In deceiving the victim(s), the attacker usually…", "Takes control of the interaction", "Hides from the victim", "Does not engage that target", "Hacks the pentagon", 1, QuizCategories.Social_Engineering);
        addQuestion(q14);
        QuizQuestions q15 = new QuizQuestions("In preparing for the attack, the attacker usually..", "Has no attacking method", "Identifies and gathers information about the victim", "Introduces themselves to the victim", "Immediately hacks the victim", 2, QuizCategories.Social_Engineering);
        addQuestion(q15);

        QuizQuestions q16 = new QuizQuestions("Psychology based attacks consist of what elements?", "Emotional and cognitive", "Behavioural and cognitive", "Behavioural and emotional", "Cognitive and disruptive", 2, QuizCategories.Psychology_Based);
        addQuestion(q16);
        QuizQuestions q17 = new QuizQuestions("There are how many ‘elements’ that make up psychology-based attacks?", "9", "2", "0", "6", 4, QuizCategories.Psychology_Based);
        addQuestion(q17);
        QuizQuestions q18 = new QuizQuestions("Which of these is an element of psychology-based attacks?", "Disliking", "Social proof", "Mismanagement", "Picture in picture", 2, QuizCategories.Psychology_Based);
       addQuestion(q12);
        QuizQuestions q19 = new QuizQuestions("Which of these is NOT an element of psychology-based attacks?", "Scarcity", "Authority", "Liking", "Social connection", 4, QuizCategories.Psychology_Based);
        addQuestion(q19);
        QuizQuestions q20 = new QuizQuestions("Finish the element “Consistency & ____", "Commitment", "Creativity", "Connection", "Continuation", 1, QuizCategories.Psychology_Based);
        addQuestion(q20);
